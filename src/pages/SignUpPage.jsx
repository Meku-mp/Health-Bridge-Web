...
function SignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     // After user is created, store additional user data (name and specialist)
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-col items-center justify-center w-2/3 px-8 max-xl:w-1/2 md:px-20 max-md:w-full">
        ...
        <h1 className="mb-[50px] text-[31.29px] font-bold text-[#123258]">HEALTHBRIDGE</h1>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          <div className="mb-4">
            <label htmlFor="name" className="block text-[#344054] text-[14px] font-medium">Name*</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          <div className="mb-8">
            <label htmlFor="specialist" className="block text-[#344054] text-[14px] font-medium">Specialist</label>
            <input
              type="text"
              id="specialist"
              name="specialist"
          ...
          >
            {loading ? 'Creating Account...' : 'Get started'} {/* Show loading text */}
          </button>
        </form>
        ...
        <p className="mt-6 text-[#101828] text-[14px]">
          ...
          <button onClick={() => navigate('/signin')} className="text-[#0E1680] hover:text-[#090b22] font-semibold text-[14px]">Log in</button>
        </p>
      </div>
